...
function informacion(){
    alert(" Esta pokedex online fue creada por los estudiantes del Tecnologico de Monterrey campus Puebla : \n Martin Octavio Garcia Garcia --- A01328971\n Manuel Amadeo Villareal Gonzalez --- A01321810 \n Cualquier duda o comentario favor de referir al boton de contacto");
}
function contactos(){
...
const missingNo = () => {
    ...
    var namePokeElement = document.getElementById("namePoke");
    var idElement = document.getElementById("id");
    spriteElement.style.background='FFF';
